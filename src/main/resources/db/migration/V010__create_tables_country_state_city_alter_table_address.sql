CREATE TABLE country (
	...
	name_pt_br varchar(60) NOT NULL,
...
INSERT INTO country (id, name, name_pt_br, initials, bacen) VALUES
...
(114, 'Korea, Democratic Peoples Republic of', 'Coreia, Republica Popular Democrática da', 'KP', 1872),
(115, 'Korea, Republic of', 'Coreia, Republica da', 'KR', 1902),
(116, 'Kuwait', 'Kuwait', 'KW', 1988),
(117, 'Kyrgyzstan', 'Quirguiz, Republica', 'KG', 6254),
(118, 'Lao Peoples Democratic Republic', 'Laos, Republica Popular Democrática do', 'LA', 4200),
...
INSERT INTO state (id, name, initials, ibge, id_country, ddd) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
INSERT INTO city (id, name, id_state, ibge) VALUES
...
ALTER TABLE person ADD COLUMN id_city BIGINT(20) NULL;

-- Nesse ponto, se fosse em produção de um sistema real, seria necessário
-- fazer um código que faça match entre as colunas anteriormente existentes
-- e os novos IDs da tabela de cidade.
-- neste caso irei dizer que todas as pessoas pertencem à cidade de São Paulo (ID 5270)
UPDATE person SET id_city = 5270;
